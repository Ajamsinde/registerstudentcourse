...
<body>
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('admin.table') }}"  class="nav-item nav-link "><i class="fa fa-table me-2"></i>course Tables </a>
                     <a href="{{ route('admin.contacttable') }}"  class="nav-item nav-link active"><i class="fa fa-table me-2"></i>contact table </a>
    ...
    <h2 class="mb-4"> "نامێت گەهشتین"</h2>
